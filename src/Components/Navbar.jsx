    ...
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#142b33] text-[#eff3f3]">
      ...
      <ul
        className={
          !openMenu
            ? "hidden"
            : "absolute top-0 left-0 w-full h-screen bg-[#142b33] flex flex-col items-center justify-center"
        }
      >
      ...
      <div className="flex fixed flex-col top-[35%] left-0">
        <ul>
          <li className="w-[80px] md:w-[142px] lg:w-[160px] h-[40px] lg:h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-14px] duration-300 lg:mb-[-14px]">
            <a
              className="flex justify-between items-center w-full text-[#eff3f3] bg-blue-600 p-2 "
            ...
            >
              LinkedIn{" "}
              <FaLinkedin
                className="mr-[-10px] lg:mr-0 duration-300 px-1"
                size={30}
              />
            </a>
          </li>
          <li className="w-[80px] md:w-[142px] lg:w-[160px] h-[40px] lg:h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-14px] duration-300 lg:mb-[-14px]">
            <a
              className="flex justify-between items-center w-full text-[#eff3f3] bg-[#333333] p-2 "
          ...
          <li className="w-[80px] md:w-[142px] lg:w-[160px] h-[40px] lg:h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-14px] duration-300 lg:mb-[-14px]">
            <a
              className="flex justify-between items-center w-full text-[#eff3f3] bg-[#6fc2b0] p-2 "
              href="mailto:nmnayana62@gmail.com"
            >
              Email{" "}
              <HiOutlineMail
                className="mr-[-10px] lg:mr-0 duration-300 px-1"
          ...
          <li className="w-[80px] md:w-[142px] lg:w-[160px] h-[40px] lg:h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-14px] duration-300 lg:mb-[-14px]">
            <a
              ...
              href="https://drive.google.com/file/d/1NohsXwvPsClqMzhWyWVE9LlASIxw8RTH/view?usp=drive_link"
              rel="noreferrer"
              target="_blank"
            >
              Resume{" "}
